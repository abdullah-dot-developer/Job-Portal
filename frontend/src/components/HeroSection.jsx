    ...
    <div className="text-center px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-5 my-10 max-w-4xl mx-auto">
        ...
        <p className="text-sm sm:text-base md:text-lg lg:text-xl max-w-xl mx-auto">
          Connecting talent with opportunity. Find your next job or hire your
          next star with CareerLinker!
        </p>
        <div className="flex w-full sm:w-[80%] md:w-[60%] lg:w-[50%] xl:w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto">
          <input
            type="text"
