  ...
  const logoutHandler = async () => {
    try {
      const res = await axios.get(
        `https://job-portal-mu3d.onrender.com/api/v1/user/logout`,
        {
      ...
      <div className="flex items-center justify-between mx-auto px-4 sm:px-6 lg:px-8 h-16">
        <div>
          <h1 className="text-2xl font-bold">
            Career<span className="text-[#F83002]">Linker</span>
          </h1>
        </div>
        <div className="flex items-center gap-4 md:gap-10">
          <ul className="hidden md:flex font-medium items-center gap-5 cursor-pointer">
